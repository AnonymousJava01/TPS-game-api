...
local banyuwangi = Instance.new("ScreenGui")
banyuwangi.Name = "banyuwangi"
banyuwangi.Parent = game.CoreGui
banyuwangi.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

MainFrame.Name = "MainFrame"
MainFrame.Parent = banyuwangi
...
identify_sec:AddButton({
    ...
    Callback = function()
        if not getgenv().Config then
            getgenv().Config = {
                Headless = false,
                FakeDisplayName = "PROTECTED BY BANYU",
                FakeName = "PROTECTED BY BANYU",
                FakeId = 666666666,
            }
        end
